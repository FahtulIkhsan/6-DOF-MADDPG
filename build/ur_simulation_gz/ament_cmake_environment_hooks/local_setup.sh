...
: ${AMENT_CURRENT_PREFIX:="/home/bejobarokah/thesis/install/ur_simulation_gz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_simulation_gz/environment/pythonpath.sh"
